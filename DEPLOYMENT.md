...
The contact form opens WhatsApp through `api.whatsapp.com` with the visitor's enquiry details addressed to `+65 8849 4321`, so no server-side form setup is required.
